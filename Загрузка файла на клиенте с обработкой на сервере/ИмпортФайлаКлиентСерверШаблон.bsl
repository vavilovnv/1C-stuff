...
Функция ПроизведенУспешныйВыборФайла()
    ...
    #Если ВебКлиент Тогда
        ...
        ПоместитьФайл(АдресФайлаВоВременномХранилище);
    ...
    #Иначе
        ...
        АдресФайлаВоВременномХранилище = ПоместитьВоВременноеХранилище(Новый ДвоичныеДанные(ДиалогФыбораФайла.ПолноеИмяФайла));
